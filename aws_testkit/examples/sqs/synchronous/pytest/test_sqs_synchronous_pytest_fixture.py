...
def test_send_and_receive_message_with_fixture(moto_testkit_fixture: tuple[SQSRepository, str]) -> None:
...
def test_delete_message_with_fixture(moto_testkit_fixture: tuple[SQSRepository, str]) -> None:
    repo, queue_url = moto_testkit_fixture
