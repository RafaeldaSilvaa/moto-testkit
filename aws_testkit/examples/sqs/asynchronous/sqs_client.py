...
class SQSAsyncClient:
    ...
    async def send_message(self, message_body: str, message_attributes: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    async def receive_messages(self, max_number_of_messages: int = 10, wait_time_seconds: int = 20) -> List[Dict[str, Any]]:
        async with aioboto3.Session().client('sqs', region_name=self.region_name) as sqs:
