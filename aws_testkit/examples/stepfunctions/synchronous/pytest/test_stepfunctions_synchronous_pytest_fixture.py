...
def test_create_state_machine_with_fixture(moto_testkit_fixture: StepFunctionsRepository) -> None:
    definition = '{"StartAt": "Hello", "States": {"Hello": {"Type": "Pass", "End": true}}}'
    role_arn = "arn:aws:iam::123456789012:role/DummyRole"
    sm = moto_testkit_fixture.create_state_machine("MyStateMachine", definition, role_arn)
