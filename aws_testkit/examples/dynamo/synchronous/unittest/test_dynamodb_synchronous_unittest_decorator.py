# test_dynamo_unittest_isolated.py
import unittest
import os
import boto3
...
class TestDynamoDBRepositoryIsolated(unittest.TestCase):
    ...
    def setUp(self, moto_testkit):
        ...
        # A tabela é criada em cada teste, garantindo que o estado não se misture
        # entre os diferentes métodos de teste.


    # Não precisamos de um tearDown explícito, pois o `moto_testkit`
    # encerra o ambiente automaticamente no final de cada teste.
    ...
    def test_put_and_get_item(self, moto_testkit):
        ...
        # Se você rodar outro teste, a tabela e os dados acima não existirão.
