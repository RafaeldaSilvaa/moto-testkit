...
@pytest.fixture
def cloudwatch_logs_repo(moto_testkit: MotoTestKit) -> Generator[CloudWatchLogsRepository, None, None]:
...
def test_create_group_and_stream(cloudwatch_logs_repo: CloudWatchLogsRepository) -> None:
